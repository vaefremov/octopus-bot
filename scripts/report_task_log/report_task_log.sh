...
# If there's nothing new, update state and exit silently
if [[ $BYTES_TO_READ -eq 0 ]]; then
    # Still update the state file to reflect current position
    # This is important for rotated-to-empty files
